...
4) Найдём при помощи пункта 3 дисперсию распределения хешей по массиву 
...
Чем меньше дисперсия, тем более равномерное распределение ключей по таблице, что крайне важно для хорошей хэш-функции.
